...
- (void)drawInteriorWithFrame:(NSRect)cellFrame inView:(NSView *)controlView {
	...
	[thumbPath fill];
	NSGradient *thumbGradient = [[NSGradient alloc] initWithStartingColor:
                                 [NSColor colorWithCalibratedWhite:THUMB_GRADIENT_MAX_Y_WHITE alpha:1.0f]
                                                              endingColor:[NSColor colorWithCalibratedWhite:THUMB_GRADIENT_MIN_Y_WHITE alpha:1.0f]];
